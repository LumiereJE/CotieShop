...
$(document).ready(function(){
    ...
    $('.ham').click(function(){
        ...
        if(ham_chk) {
            move($('#line_top'), 'translateY(21.5rem)' ,'translateY(21.5rem) rotate(45deg)')
            move($('#line_mid'), -1, 'scale(0)')
            move($('#line_bot'), 'translateY(-21.5rem)' ,'translateY(-21.5rem) rotate(-45deg)' )
            ham_chk=false
        }
        else if(!ham_chk) {
            move($('#line_top'), 'translateY(12.5rem) rotate(0)', 'translateY(0)')
            move($('#line_mid'), -1, 'scale(1)')
            move($('#line_bot'), 'translateY(-12.5rem) rotate(0)', 'translateY(0)')
            ham_chk=true 
        }
